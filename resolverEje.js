...
/* 21) Programa una función que dado un array numérico devuelve otro array con los números elevados al cuadrado, 
    ...
    const elevarCuadrado = (numeros = undefined) => {
      if (numeros === undefined) return console.log("Debes Ingresar un array de numeros");
    
      if (numeros.length === 0) return console.log("El array ingresado está Vacio");
    
      if (!(numeros instanceof Array)) return console.log(`El valor ${numeros} no es un Array de Numeros`);
    
      for (let num of numeros) {
       if(typeof num !== "number") return console.log(`El valor ${num} ingresado no es valido`)
      }
        const newNumeros = numeros.map(el => el * el)

      return console.log(`El arreglo original es ${numeros},\n Areglo elevado al cuadrado : ${newNumeros}`);
    }
    // elevarCuadrado();
    // elevarCuadrado("hola");
    // elevarCuadrado(345);
...
/* 22) Programa una función que dado un array devuelva el número mas alto y el más bajo de dicho array, pe. 
    miFuncion([1, 4, 5, 99, -60]) devolverá [99, -60] */
      const DevolverNumeroMax = (numeros = undefined) =>{
      if (numeros === undefined) return console.log("Debes Ingresar un array de numeros");
      ...
      return console.info(`Arreglo original ${numeros}\nValor mayor : ${Math.max(...numeros)},\n
      Valor menor:${Math.min(...numeros)}`) 
        
      }
      DevolverNumeroMax()
      DevolverNumeroMax(false)
      DevolverNumeroMax([])
      DevolverNumeroMax([2,3,89,58])
